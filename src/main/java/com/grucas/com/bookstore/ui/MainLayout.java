package com.grucas.com.bookstore.ui;
...
import com.grucas.com.bookstore.ui.inventory.InventoryView;

/**
 * The main layout. Contains the navigation menu.
 */
@Theme(value = Lumo.class)
@PWA(name = "Portal grucas", shortName = "Portal Grucas")
@CssImport("./styles/shared-styles.css")
@CssImport(value = "./styles/menu-buttons.css", themeFor = "vaadin-button")
@CssImport(value = "./styles/app-layout.css", themeFor = "vaadin-app-layout")
@CssImport(value = "./styles/app-menu-header.css", themeFor = "vaadin-horizontal-layout")
public class MainLayout extends AppLayout implements RouterLayout {
    ...
    public MainLayout() {
        ...
        top.getElement().setAttribute("theme","dark");
        top.setSizeFull();
        ...
        final Label title = new Label("Portal de Clientes");
